...
- **Resume:** `/clear` → "**continue F5**" (States · Motion — playbook §9: 4 state warm mọi surface + ngân sách 5-spectacle degrade 3-tier + motion polish). Sau F5 → F6 → F7. Mỗi phase = 1 context sạch, commit + tag trước clear.
