...
export default function ThresholdStatic() {
  return (
    <div className="bg-void absolute inset-0 flex flex-col items-center justify-center gap-6 px-6">
      <SignalDot tone="signal" size="lg" />
      <p className="text-3xl leading-none md:text-5xl">
        <span className="font-display text-on-void italic">Schoo</span>
        <span className="text-cobalt-lift font-sans font-semibold">IOS</span>
      </p>
      <p className="text-on-void-3 font-mono text-[11px] tracking-[0.3em] uppercase">Đài Lặng</p>
    </div>
  );
}
